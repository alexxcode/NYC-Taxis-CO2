...
def transform_data(df):
    ...
    #fixing bq problem
    df.rename(columns={'Start date/time in UTC': 'start_datetime_utc'}, inplace=True)
    df.rename(columns={'Duration (s)': 'Duration'}, inplace=True)
    df.rename(columns={'Mean volume (dBA)': 'Mean volume'}, inplace=True)
